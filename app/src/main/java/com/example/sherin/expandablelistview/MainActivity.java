package com.example.sherin.expandablelistview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void preparedData() {
        String[] parent_poet = getResources().getStringArray(R.array.poetName);
        String[] child_details = getResources().getStringArray(R.array.child_poet);
        ...
        expandable_listView = new Expandable_ListView(this, parent, child, pictures);
